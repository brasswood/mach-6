...
use mach_6::{self, Optimizations, result::{IntoResultExt, Result}};
use test_log::test;
...
fn ensures_websites_is_dir() -> io::Result<()> {
    ...
    match mach_6::do_all_websites(websites_file.path(), Optimizations::default()) {
...
fn skips_non_dir_websites() -> Result<()> {
    ...
    let res = mach_6::do_all_websites(websites_path, Optimizations::default())?;
