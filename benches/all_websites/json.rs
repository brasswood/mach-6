    ...
    BenchmarkRunJson {
        ...
        stats: WebsiteStatsJson {
            ...
            time_spent_updating_bloom_filter_display: format_duration(
                mean_timing_stats.updating_bloom_filter,
            ),
            time_spent_slow_rejecting_ns: mean_timing_stats.slow_rejecting.as_nanos(),
            time_spent_slow_rejecting_display: format_duration(mean_timing_stats.slow_rejecting),
            time_spent_slow_accepting_ns: mean_timing_stats.slow_accepting.as_nanos(),
            time_spent_slow_accepting_display: format_duration(mean_timing_stats.slow_accepting),
            time_spent_fast_rejecting_ns: mean_timing_stats.fast_rejecting.as_nanos(),
            time_spent_fast_rejecting_display: format_duration(mean_timing_stats.fast_rejecting),
            ...
            time_spent_checking_style_sharing_display: format_duration(
                mean_timing_stats.checking_style_sharing,
            ),
            ...
            time_spent_inserting_into_sharing_cache_display: format_duration(
                mean_timing_stats.inserting_into_sharing_cache,
            ),
            ...
            time_spent_querying_selector_map_display: format_duration(
                mean_timing_stats.querying_selector_map,
            ),
        },
    }
}
